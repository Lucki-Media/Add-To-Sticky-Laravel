<!DOCTYPE htmlonly screen and (ma
...
<head>
  ...
  <title>Luckimedia</title><!--[if (mso 16)]>
    <style type="text/css">
...
<![endif]--><!--[if !mso]><!-- -->
  ...
  <style type="text/css">
    .banner-img {
      background-image: url(https://luckistore.in/lm-req01.png) !important;
    }
...
<body
  ...
  <div class="es-wrapper-color" style="background-color:#F6F6F6"><!--[if gte mso 9]>
		...
		<![endif]-->
    <table class="es-wrapper main-page" width="100%" cellspacing="0" cellpadding="0"
      style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0 auto;width:560px;height:100%;background-repeat:repeat;background-position:center top;background-color:#F6F6F6">
      <tr>
        <td valign="top" style="padding:0;Margin:0">
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table class="es-header-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                  ...
                  <tr>
                    <td align="left" style="padding:20px;Margin:0;background:#ffffff;">
                                ...
                                <td align="center"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><a
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px"><img
                                      class="adapt-img" src="https://luckistore.in/luckimedia_mail_logo.png" alt
                                      style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                      height="auto" width="70%"></a></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                ...
                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                  ...
                  <tr>
                    <td style="padding:0;Margin:0;background-position:left top" align="left">
                      <table bgcolor="#304050" align="center" width="560px" class="margin-full ui-resizable banner-img"
                      ...
                      ;" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <table width="560px" align="center" class="margin-pad" border="0" cellpadding="0"
                                cellspacing="0">
                                <tbody>
                                  <tr>
                                  ...
                                  <tr>
                                    <td class="res-center"
                                      style="text-align: center; color: white; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size: 26px; letter-spacing: 1.5px; word-break: break-word; font-weight: 300; padding-left: 1.5px;"
                                      data-color="M1 Title 1" data-size="M1 Title 1" data-max="36" data-min="16">
                                      WE ARE THE CREATIVE
                                    </td>
                                  </tr>
                                  <!-- title end -->
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td class="res-center" style="text-align: center;">
                                                      <a href="https://apps.shopify.com/lm-request-a-quote"
                                                        class="es-button es-button-1"
                                                        style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 45px;display:inline-block;background:#002278;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #002278;">
                                                        Visit </a>
                                                    </td>
                                                  </tr>
                                                  <!-- link end -->
                        ...
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:100%;">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left"
                                  style="Margin:0;padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#000000;font-size:25px; font-weight: 500;">
                                    Hi {{ $data['shop_name'] }},</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-left:25px;padding-right:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    While we understand that everyone's needs and preferences vary, we want to assure
                                    you that your feedback and experience are important to us.
                                  </p>
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0"><span class="es-button-border"
                                    style="border-style:solid;border-color:transparent;border-width:0px;display:inline-block;width:auto"><a
                                      href="https://apps.shopify.com/lm-request-a-quote#adp-reviews"
                                      class="es-button es-button-1"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 45px;display:inline-block;background:#002278;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #002278;margin-top: 30px;">CLICK HERE FOR REVIEW </a></span></td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-left:25px;padding-right:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    <br><br>
                                    We would greatly appreciate it if you could spare a moment to share your thoughts
                                    regarding your decision to uninstall our app. Your feedback will assist us in
                                    identifying areas for improvement and ensuring that we continue to deliver an
                              ...
                              <tr>
                                <td align="left"
                                  style="Margin:0;padding-bottom:10px;padding-top:15px;padding-left:25px;padding-right:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#333333;font-size:14px">
                              ...
                              <!-- <tr>
                                <td align="left"
                                  style="padding:0;Margin:0;padding-bottom:5px;padding-left:25px;padding-right:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    <b>Somin Parate</b>
                                  </p>
          ...
          <table cellpadding="0" cellspacing="0" class="es-content" align="center"
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:100%; border-top:1px solid #333 ;">
                  <tr>
                    <td align="left"
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-infoblock" align="center"
                                  ...
                                  <p target="_blank" href=""
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#333;font-size:18px">
                                    Review collection powered by <a href="https://luckimedia.in/"
                                      style="text-decoration: none;color:#002278;">luckimedia.in</a></p>
                                  </p>
                                </td>
                              </tr>
                            </table>
