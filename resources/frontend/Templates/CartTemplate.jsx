...
export default function CartTemplate1(props) {
    console.log(props.template_data.buy_btn_settings.edit_text);
    ...
    const CustomizedButton = Button.extend`
        ...
        padding: 13px 40px;
        min-height: inherit;
        min-width: ${props.template_data.buy_btn_settings.btn_width}px;
        color: ${props.template_data.buy_btn_settings.btn_text_color};
        background: ${props.template_data.buy_btn_settings.btn_bg_color};
        border-radius: ${props.template_data.buy_btn_settings
            ...
            <div className={style.lm_container}>
                <div className={style.lm_cart_module}>
                    ...
                    <div className={style.lmblock_right}>
                        ...
                        <div className="lm_buy_btn">
                            <CustomizedButton onClick={() => alert("Welcome!")}>
                                {props.template_data.buy_btn_settings.edit_text}
                            </CustomizedButton>
                        </div>
                    </div>
                </div>
