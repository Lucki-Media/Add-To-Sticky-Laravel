...
function GeneralSettings(props) {
    ...
    const handleTextColor = useCallback(
        (newChecked) => setGsNotificationBarTextColor(newChecked),
        []
    );

    const handleTextColor = (event) => {
        setGsPrisetGsNotificationBarTextColorceColor(event.target.value);
    };

    // Notification Bar Text Color Handle Event
    const handleBgColor = useCallback(
        (newChecked) => setGsNotificationBarBgColor(newChecked),
        []
    );
