...
function GeneralSettings(props) {
    ...
    console.log("gsNotificationBarText");
    console.log(props.gsNotificationBarText);
    ...
    const handleNbTextFieldChange = (value) => {
        console.log("Condition changed to:", value);
        setGsNotificationBarText(value);
    };

    const handleNbTextFieldChange = useCallback(
        (value) => setCheckMobile(newChecked),
        []
    );
