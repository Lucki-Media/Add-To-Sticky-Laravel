...
export function BuyNowSettings(props) {
    ...
    const callbackFunction = useCallback(() => {
        props.callback({
            ...
            gsNotificationBarTextColor :  props.gsNotificationBarBold,
            gsNotificationBarBgColor :  props.gsNotificationBarBold,
            gsNotificationBarFontSize :  props.gsNotificationBarBold,
            gsNotificationBarHeight :  props.gsNotificationBarBold,
