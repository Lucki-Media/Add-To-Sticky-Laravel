...
export default function AddToCartSticky() {
    ...
    const [gsNotificationBarText , setGsNotificationBarText] = useState(false);
    const [gsNotificationBarItalic , setGsNotificationBarItalic] = useState(false);
    const [gsNotificationBarTitleColor , setGsNotificationBarTitleColor] = useState("#ffffff");
    const [gsNotificationBarBgColor , setGsNotificationBarBgColor] = useState("#000000");
    const [gsNotificationBarFontsize , setGsNotificationBarFontsize] = useState(12);
    const [gsNotificationBarHeight , setGsNotificationBarHeight] = useState(12);
