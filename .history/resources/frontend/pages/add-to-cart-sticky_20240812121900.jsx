...
export default function AddToCartSticky() {
    ...
    const handleTransferData = (data) => {
        ...
        setGsNotificationBarTextColor(data.general_settings.gsNotificationBarTextColor);
        setGsNotificationBarBgColor(data.general_settings.gsNotificationBarBgColor);
