...
export default function CartTemplate1(props) {
    ...
    const position = template_data.general_settings.position,
        ...
        gsNotificationBarText = template_data.general_settings.gsNotificationBarText,
        gsNotificationBarItalic = template_data.general_settings.gsNotificationBarText,
